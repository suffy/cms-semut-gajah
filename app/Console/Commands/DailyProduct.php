...
class DailyProduct extends Command
{
    ...
    private $brands = [
        ...
        '005' => 'ultra sakti',
        '007' => 'vonix latexindo',
        '008' => 'bintang kupu kupu',
        '009' => 'unilever',
        '010' => 'natura vita utama',
        '011' => 'herbana',
        '012' => 'intrafood singabera',
        '013' => 'nutrisi harapan bangsa',
        '014' => 'heavenly nutrition indonesia',
    ];
    ...
    public function store($datas)
    {
        ...
        foreach ($products as $product) {
            ...
            $data = $existingProducts[$product['kodeprod']] ?? null;
            ...
            if (is_null($data)) {
                ...
                $productSave = $this->products->Create(
                    [
                        ...
                        'type_status'               => $product['apps_status_type'], //
                        'updated_at'                => $apps_last_updated,
                        'sync_hash'                 => md5(json_encode($product))
                    ]
                );
                ...
                if ($data->sync_hash != md5(json_encode($product))) {
                    // get image and store at folder
                    $old_image       = $data->image;
                    $product_image   = $old_image;
                    if ($product['apps_images']) {
