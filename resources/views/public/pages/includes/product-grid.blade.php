<div class="header-product d-flex align-items-center" style="border: solid 1px lightgray; margin: 15px; margin-top: 50px; padding: 10px 15px">
        <h3>Shop / <span style="font-size: 12pt">{{$category}}</span></h3> 
