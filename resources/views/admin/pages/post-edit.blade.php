...
<a href="{{url('admin/posts?type='.$type)}}" class="btn btn-blue">Back</a><br><br>
                    ...
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade show card-body active" id="tab-id" role="tabpanel" aria-labelledby="nav-id" style=" border: 1px solid #dddddd">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12">
                                    <textarea name="excerpt" class="form-control" placeholder="Preview" value="">{{$post->excerpt}}</textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-12 col-form-label">Kata Kunci</label>
                                <div class="col-sm-12">
                                    <textarea name="keyword" class="form-control" placeholder="Keywords">{{$post->keyword}}</textarea>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane fade card-body" id="tab-en" role="tabpanel" aria-labelledby="nav-en" style=" border: 1px solid #dddddd">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" name="title_en" class="form-control" placeholder="Title" value="{{$post->title_en}}">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12">
                                    <a href="" data-toggle="modal" class="btn btn-blue btn-sm" data-target="#addImages">Add Media Images</a><br><br>
                                    <textarea class="editor"  name="content_en">{{$post->content_en}}</textarea>
                                </div>
                            </div>
                            <hr>
                            <header class="panel-heading">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-12 col-form-label">Text Preview</label>
                                <div class="col-sm-12">
                                    <textarea name="excerpt_en" class="form-control" placeholder="Preview" value="">{{$post->excerpt_en}}</textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-12 col-form-label">Keyword</label>
                                <div class="col-sm-12">
                                    <textarea name="keyword_en" class="form-control" placeholder="Keywords">{{$post->keyword_en}}</textarea>
                                </div>
                            </div>
                        </div>
    ...
    <div class="col-md-3 col-sm-12 col-xs-12">
        <section id="newPost" class="panel">
            ...
            <div class="card-body">
                ...
                <hr>
                    <label><input type="radio" name="status" value="1" @if($post->status=='1')checked @endif> Publish</label> &nbsp
                    <label><input type="radio" name="status" value="0" @if($post->status=='0')checked @endif> Draft</label>
                <hr>
        ...
        <section id="newPost" class="panel">
            ...
            <div class="card-body">
                ...
                <img id="blah" src="{{asset($post->featured_image)}}" alt="your image" class="img-fluid"/><br><br>
            ...
            <div class="card-body">
                <textarea type="text" class="form-control" id="input-featured_video" name="featured_video">{{$post->featured_video}}</textarea>
            ...
            <div class="card-body">
                ...
                @foreach($category as $s)
                    ...
                    <label><input type="radio" name="category_id" value="{{$s->id}}" @if($s->id==$post->post_category_id) checked @endif required> &nbsp {{$s->name}}</label><br>
                    @foreach($s->sub_cat as $row2)
                    &nbsp<span class="fa fa-angle-right"></span><label style="margin-left: 15px;"><input type="radio" name="category_id" value="{{$row2->id}}" @if($row2->id==$post->post_category_id) checked @endif required> &nbsp {{$row2->name}}</label><br>
                    @endforeach
            ...
            <div class="card-body">
                <input type="text" class="form-control" id="input-tags" name="tags" value="{{$post->tags}}">
