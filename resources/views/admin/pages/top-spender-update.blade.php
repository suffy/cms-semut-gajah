            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }} row">
                        ...
                        <div class="col-sm-12">
                            <input type="hidden" name="id" value="{{$topSpender->id}}">
                            <input type="text" name="title" class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" placeholder="Judul..." value="{{$topSpender->title}}">
                ...
                <div class="col-md-4">
                    <div class="form-group {{ $errors->has('start') ? 'has-error' : '' }} row">
                        ...
                        <div class="col-sm-12">
                            <input type="text" name="start" class="form-control {{ $errors->has('start') ? 'is-invalid' : '' }}" placeholder="Periode Awal..." value="{{$topSpender->start}}" onfocus="(this.type='date')" onblur="(this.type='text')">
                            <div class="invalid-feedback">
                                {{ $errors->first('start') }}
                            </div>
                        </div>
                ...
                <div class="col-md-4">
                    <div class="form-group {{ $errors->has('end') ? 'has-error' : '' }} row">
                        ...
                        <div class="col-sm-12">
                            <input type="text" name="end" class="form-control {{ $errors->has('end') ? 'is-invalid' : '' }}" placeholder="Periode Akhir.." value="{{$topSpender->end}}" onfocus="(this.type='date')" onblur="(this.type='text')">
                            <div class="invalid-feedback">
                                {{ $errors->first('end') }}
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group {{ $errors->has('description') ? 'has-error' : '' }} row">
                        ...
                        <div class="col-sm-12">
                            <textarea name="description" class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" cols="10" rows="10" style="margin-top: 0px; margin-bottom: 0px; height: 119px; resize:none;" placeholder="Description...">{{$topSpender->description}}</textarea>
                            <div class="invalid-feedback">
                    ...
                    <div class="form-group {{ $errors->has('brand_id') ? 'has-error' : '' }} row">
                        ...
                        <div class="col-sm-12">
                            <select class="form-control" id="brand_id" name="brand_id">
                                ...
                                <option value="{{$value}}" @if($topSpender->brand_id == $value) selected @endif>{{ucwords($row)}}</option>
                                @endforeach
                            </select>
                            <div class="invalid-feedback">
            ...
            <div class="row">
                    ...
                    <div class="form-group {{ $errors->has('reward') ? 'has-error' : '' }} row">
                        ...
                        <div class="col-sm-12">
                            <select class="form-control" id="reward" name="reward">
                                ...
                                <option value="cash" @if($topSpender->reward == "cash") selected @endif>Cash</option>
                                <option value="point" @if($topSpender->reward == "point") selected @endif>Point</option>
                            </select>
                            <div class="invalid-feedback">
                                {{ $errors->first('reward') }}
                            </div>
                ...
                <div class="col-md-4">
                    <div class="form-group {{ $errors->has('limit') ? 'has-error' : '' }} row">
                        ...
                        <div class="col-sm-12">
                            <input type="number" step="1" min="1" id="limit" name="limit" class="form-control {{ $errors->has('limit') ? 'is-invalid' : '' }}" placeholder="Limit..." value="{{$topSpender->limit}}" onchange="showList()">
                            <div class="invalid-feedback">
                                {{ $errors->first('limit') }}
                            </div>
                        </div>
...
<script>
    $(document).ready(function() {
        ...
        const rank_reward = @json($topSpender -> rank_reward);
        $('#rankReward').html('');
        rank_reward.map(function(item, index) {
            $('#rankReward').append(
                '<div class="col-md-12">' +
                '<div class="col-md-4">' +
                '<div class="form-group row">' +
                '<label class="col-sm-12 col-form-label">Rank ' + (index + 1) + ' Reward</label>' +
                '<div class="col-sm-12">' +
                '<input type="hidden" name="pos[]" value="' + (item.pos) + '">' +
                '<input type="text" name="nominal[]" class="form-control" placeholder="Nominal..." value="' + (item.nominal) + '">' +
                '</div>' +
                '</div>' +
                '</div>' +
                '</div>'
