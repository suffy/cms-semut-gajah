  ...
  <div class="" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="title">Upload User Excel</h5>
      </div>
      <div class="modal-body">
            <form action="{{url('manager/access/upload-excel')}}" method="post" enctype="multipart/form-data">
				@csrf
				...
				<div class="form-group">
					...
					<div class="col-sm-12">
						...
						<hr>
						<a href="{{asset('user_master.xlsx')}}"><span class="fa fa-download"></span> Download Contoh Excel</a>
						<hr>
						
						<img src="{{asset('example-import-user.png')}}" style="max-width: 650px" class="img-fluid">
						<hr>
					</div>
				</div>
			</form>
